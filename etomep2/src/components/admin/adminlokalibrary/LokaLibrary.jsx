      ...
      <Container className="loka_lib_container">
        <form className="loka_lib_form">
          ...
          >
            ...
            <h1 className="loka_lib_title">Add Library</h1>
          </div>
            ...
            <Row style={{ paddingTop: "20px" }}>
              <Col md={6}>
                <div className="loka_library_group">
                  <label htmlFor="textbookName">Title of the Book</label>
                  <input
                    type="text"
                    id="textbookName"
                    name="textbookName"
              ...
              <Col md={6}>
                <div className="loka_library_group">
                  <label htmlFor="volume">Author</label>
                  <input
                    type="text"
                    id="volume"
                    name="volume"
                ...
                <div className="loka_library_group">
                  ...
                  <input styles={customStyles} type="text" />
                </div>
              </Col>
            </Row>
