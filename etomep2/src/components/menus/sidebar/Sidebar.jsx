...
function Sidebar() {
 ...
 <div className='sidebar_header'>
      ...
      <Row
        ...
        <Col  className={`menu_item_col ${activeItem === 'home' ? 'active' : ''}`} onClick={() => handleMenuItemClick('home')}>
       ...
       <Link  to='/institutionadding'>
        ...
        <Col className={`menu_item_col ${activeItem === 'aarna' ? 'active' : ''}`} onClick={() => handleMenuItemClick('aarna')}>
        <div className='icon_container_div'>
            <SlNote  className="icon_img" />
            <span className="icon-text">Aarna</span>
          </div>
        </Col>
        <Col className={`menu_item_col ${activeItem === 'eyora' ? 'active' : ''}`} onClick={() => handleMenuItemClick('eyora')}>
          <div className='icon_container_div'>
            <TbScanEye className="icon_img" />
            <span className="icon-text">Eyora</span>
          </div>
        </Col>
        <Col  className={`menu_item_col ${activeItem === 'settings' ? 'active' : ''}`} onClick={() => handleMenuItemClick('settings')}>
        <div className='icon_container_div'>
